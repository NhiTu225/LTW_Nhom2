...
// Hứng tham số quản lý tuyến đường
$page = $_GET['page'] ?? 'home';

// Khu vực Router - Tách biệt hoàn toàn các trang để không bị dính giao diện vào nhau
switch ($page) {
    case 'home':
        // Từ khóa và danh mục (Chỉ chạy khi ở trang chủ)
        ...
        if ($selected_category !== '') {
            // Sửa lại thành 'category_id' cho đúng cấu trúc bảng của em, hoặc giữ 'category' tùy thuộc db thực tế
